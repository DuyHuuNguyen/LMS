...
public interface UploadingSessionRepository extends JpaRepository<UploadingSession, Long> {
    ...
    """, nativeQuery = true)
    Boolean verifyNextPartNumberBySessionId(@Param("id") Long id, @Param("nextPartNumber") Integer nextPartNumber);
    ...
    @Query(value = """
        ...
        """)
    List<EtagPartNumberDTO> findAllById(@Param("id") Long id);
}
