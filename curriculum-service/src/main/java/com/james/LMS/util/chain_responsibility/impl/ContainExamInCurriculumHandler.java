...
public class ContainExamInCurriculumHandler implements ChainResponsibilityHandler {
  ...
  public void handleRequest(Object object) {
    ...
    boolean isHasExamInSession =
        this.examService.existByExamIdAndSessionId(
            curriculumRequest.getExamId(), curriculumRequest.getSessionId());
    if (!isHasExamInSession) throw new RuntimeException("Exam not found in curriculum");
    log.info("Pass");
