...
public class S3ServiceImpl implements S3Service {
    ...
    UploadPartResponse response =
        s3Client.uploadPart(
            ...
            RequestBody.fromInputStream(
                uploadingPartDTO.inputStream(), uploadingPartDTO.contentLength()));
  ...
  @Override
  public void abortMultipartUpload(AbortMultiPartUploadDTO abortMultiPartUploadDTO) {

    AbortMultipartUploadRequest request =
        AbortMultipartUploadRequest.builder()
            .bucket(abortMultiPartUploadDTO.bucket())
            .key(abortMultiPartUploadDTO.objectKey())
            .uploadId(abortMultiPartUploadDTO.uploadId())
            .build();
